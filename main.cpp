...
{   
    ...
    std::vector<std::string> b = util::FullText((std::string)PROJECT_DIR + "/biblia-em-txt.txt");
    ...
    std::vector<std::string> text = util::FullText((std::string)PROJECT_DIR + "/texto_cifrado.txt");
    // BruteForce(crpt);
